...
> **Triển khai hiện tại:** logic đã port sang **Finance Buddy demo** — `src-tauri/src/finrag/` (Rust + SQLite trong Tauri), UI `/bctc`. Không còn stack Python/Docker/Postgres trong repo này; file này giữ làm **spec tham chiếu**.
