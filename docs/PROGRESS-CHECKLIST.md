...
| Trang sản phẩm Insight (`/insight`) | **~75%** | Pipeline insight theo sổ; UI FireAnt đa danh mục |
...
| 6.1.5 | Chỉ báo MA20, RSI (OHLCV thật) | [x] | `ChartsIndicatorsPanel`, `fetchChartBars`, `chart/indicators.ts` |
...
| **30/05/2026** | **Risk engine** (rust-finance) — VaR, drawdown NAV, correlation, `PortfolioRiskPanel` |
